...
css.attr({
  rel:  "stylesheet",
  type: "text/css",
  href: "//cdn.rawgit.com/sigein/jquery-cdn/master/cw-style.css" //здесь указывается URL стилевого файла
});
...
function close_cw() {
  ...
  if (cw_status) {
    ...
    document.getElementById('cw_form').reset();
  }
...
request.open('GET', '//cdn.rawgit.com/sigein/jquery-cdn/master/cw.html');
